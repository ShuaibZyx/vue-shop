            ...
            <el-row :gutter="25">
                <el-col :span="9">
                    <el-input placeholder="请输入内容" v-model="queryInfo.query">
                        <el-button slot="append" icon="el-icon-search" @click="getUserList" clearable
                            @clear="getUserList"></el-button>
                    </el-input>
                </el-col>
                <el-col :span="4">
                ...
                addFormRules: {
                    ...
                    mobile: [
                        { required: true, message: '请输入手机号码', trigger: 'blur' },
                        {
                            ...
                            message: '手机号码格式不符合', trigger: 'blur'
                        }
                    ],
                },
